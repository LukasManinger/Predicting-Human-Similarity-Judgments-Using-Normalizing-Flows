...
parser.add_argument("--preprocess_mode", default=2, type=int, help="Changes preprocessing.")
parser.add_argument("--epochs", default=10, type=int, help="Number of epochs.")
parser.add_argument("--batch_size", default=64, type=int, help="Batch size.")
parser.add_argument("--learning_rate", default=1e-3, type=float, help="Initial learning rate.")
parser.add_argument("--cosine_decay_steps", default=1000, type=int, help="See CosineDecayRestarts.")
...
parser.add_argument("--cosine_decay_alpha", default=0.0, type=float, help="See CosineDecayRestarts.")
parser.add_argument("--fit_verbose", default=1, type=int, help="Sets verbosity of keras fitting.")
parser.add_argument("--name", default="resnet", type=str, help="Name of model (folder).")
